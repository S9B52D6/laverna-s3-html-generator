...
bucketSize = Bucket.getObjectCount()
...
bucketList = Bucket.getObjectsAsList()
...
for note in notesNeedingGeneration:
    ...
    if note["notebookId"] != "0":
        ...
        outputFileName = "../../../../generated-files/{}/{}.html".format(notebookName, note["title"].replace(' ', '-'))
    else:
        outputFileName = "../../../../generated-files/{}.html".format(note["title"].replace(' ', '-'))
